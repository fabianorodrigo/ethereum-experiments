...
contract Game {
    ...
    /**
     * @notice Randomly picks a number out of `0 to 2²⁵⁶–1`.
     */
    ...
    /**
     * @notice  It begins the game by first choosing a ramdom number by calling `pickACard`
    ...
    /**
     * @notice It returns the balance of ether in the contract
     */
